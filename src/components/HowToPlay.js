...
export default function HowToPlay({ mode, showModal, closeModal }) {
          ...
          <div className="modal-card">
            ...
            <section className="modal-card-body">
              ...
              <p className="p-2">
                ...
                each character will appear within the grid (you'll start to see
                them change colour when you check your solution).
              </p>
